...
BOT_TOKEN = environ.get('BOT_TOKEN', '7041695823:AAG0csbGjGcOdal3gsWzCOZvsoQR1n3A-3k')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6762558871').split()]
USERNAME = environ.get('USERNAME', "https://t.me/HeartThieft_bot") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002391269521'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/MovieRequestccm')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002181741528').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002473870580'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002494713645'))
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002369002372')
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002159407577'))
...
SHORTENER_API = environ.get("SHORTENER_API", "89c5f49bb30bf45ddae5d35314cc7525a36aceb0")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'gplinks.com')
SHORTENER_API2 = environ.get("SHORTENER_API2", "89c5f49bb30bf45ddae5d35314cc7525a36aceb0")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'gplinks.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "89c5f49bb30bf45ddae5d35314cc7525a36aceb0")
